  ...
  <main id="top" class="wrap">
    <section class="hero">
      ...
      <div>
        ...
        <div class="hero-actions"><a class="btn primary" href="#demo">จอง Pilot Factory</a><a class="btn" href="#platform">ดูระบบทำงาน</a><a class="btn" href="__LINE_CONNECT_URL__" target="_blank" rel="noopener">Add LINE OA</a><a class="btn" href="__TELEGRAM_CONNECT_URL__" target="_blank" rel="noopener">Start Telegram Bot</a></div>
